...
from agents import AirConditioner, Refrigerator, WashingMachine, DishWasher, AirFryerAgent
...
async def main():
    ...
    jid_list = [ac_jid, fridge_jid, whashing_machine_jid, dish_washer_jid, battery_jid, air_fryer_jid]
