...
from agents import AirConditioner, Refrigerator, WashingMachine, DishWasher, SolarPanelAgent, BatteryAgent
...
async def main():
    ...
    jid_list = [ac_jid, fridge_jid, whashing_machine_jid, dish_washer_jid, solar_jid, battery_jid]
