...
# Washing Machine
WASHING_MACHINE_THRESHOLD = 10
WASHING_MACHINE_CYCLE_DURATION_STEPS = 2
WASHING_MACHINE_PER_CYCLE = 10
WASHING_MACHINE_ACCUMULATION_RATE = 2
WASHING_MACHINE_PRICE_SENSITIVITY = 2
WASHING_MACHINE_ACTIVE_POWER_KW = 0.5
WASHING_MACHINE_IDLE_POWER_KW = 0.0
WASHING_MACHINE_WAITING_BONUS_DIVIDER = 3
WASHING_MACHINE_PRIORITY_THRESHOLDS = [25, 20] # Counts for priority 3, 2